...
model_CategoricalNB_clf = pickle.load(open('ClassificationWDE/MeretWDE/model_LogisticRegression.pkl', 'rb'))
model_decision_tree_clf = pickle.load(open('ClassificationWDE/MeretWDE/model_decision_tree.pkl', 'rb'))
model_LogisticRegression_clf = pickle.load(open('ClassificationWDE/MeretWDE/model_LogisticRegression.pkl', 'rb'))
